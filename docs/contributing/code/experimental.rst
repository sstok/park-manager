...
All Park-Manager features benefit from our :doc:`Backward Compatibility Promise
...
can never be introduced in a last major release. The core team can decide to
extend the experimental period for another minor version on a case by case basis.
