...
* The code follows the :doc:`Park-Manager Coding Standards </contributing/code/standards>`
...
* You should put a ``$`` in front of every terminal line.
...
* You should use a form of *you* instead of *we* (either avoid the first person
