...
is a great way to get started with contributing to the Park-Manager community.
...
big challenge, especially if you remember that the Park-Manager community
...
.. tip::
    ...
    prevent possible confusion, and keeping the Park-Manager community a
...
**Examples of valid reasons to reject:**
    ...
    * That change would introduce too many performance problems.
    ...
    * Code doesn't match Park-Manager's CS rules (e.g. use ``[]`` instead of ``array()``)
...
It may not be optimal or conform the Park-Manager coding style.
