...
project = 'Park-Manager Documentation'
copyright = ''
...
htmlhelp_basename = 'ParkManagerDoc'
...
latex_documents = [
  ('index', 'Park-Manager.tex', u'Park-Manager Documentation',
   u'Park-Manager community', 'manual'),
]
...
man_pages = [
    ('index', 'park-manager', u'Park-Manager Documentation',
     [u'Park-Manager community'], 1)
]
...
texinfo_documents = [
  ('index', 'Park-Manager', u'Park-Manager Documentation',
   u'Park-Manager community', 'Park-Manager', 'One line description of project.',
   'Miscellaneous'),
]
