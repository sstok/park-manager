...
use ParkManager\Application\Command\Client\RequestPasswordReset;
...
final class RequestPasswordResetAction
{
     ...
     * @Route(
     *     path="/password-reset",
     *     name="park_manager.client.security_request_password_reset",
     *     methods={"GET", "POST"}
     * )
     *
    ...
    public function __invoke(Request $request, FormFactoryInterface $formFactory): object
    {
        ...
        $response = new TwigResponse('client/security/password_reset.html.twig', $form);
        $response->setPrivate();
