...
namespace ParkManager\Module\CoreModule\Tests\DependencyInjection\Module;

use Doctrine\Bundle\DoctrineBundle\DependencyInjection\Compiler\DoctrineOrmMappingsPass;
use LogicException;
use ParkManager\Module\CoreModule\DependencyInjection\Module\AbstractParkManagerModule;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\DoctrineMappingsModule\DoctrineMappingsModule;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\ExtensionAbsentModule\ExtensionAbsentModule;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\ExtensionAliasNotValidModule\ExtensionAliasNotValidModule;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\ExtensionNotValidModule\ExtensionNotValidModule;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\ExtensionPresentModule\DependencyInjection\DependencyExtension;
use ParkManager\Module\CoreModule\Tests\DependencyInjection\Module\Fixtures\ExtensionPresentModule\ExtensionPresentModule;
...
class ModuleTest extends TestCase
{
    ...
    public function it_guesses_name_of_the_module(): void
    {
        ...
        $this->assertSame('ParkManager\Module\CoreModule\Tests\DependencyInjection\Module', $module->getNamespace());
    ...
    public function it_registers_doctrine_mapping_when_present(): void
    {
        ...
        self::assertContainsEquals(
            DoctrineOrmMappingsPass::createXmlMappingDriver([
                $module->getPath() . '/Doctrine/Account/Mapping' => $module->getNamespace() . '\\Domain\\Account',
            ]),
            $containerBuilder->getCompilerPassConfig()->getPasses(),
            ''
        );
