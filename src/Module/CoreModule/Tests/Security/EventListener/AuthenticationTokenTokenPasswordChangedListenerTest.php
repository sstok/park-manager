...
namespace ParkManager\Module\CoreModule\Tests\Security\EventListener;

use ParkManager\Module\CoreModule\Event\UserPasswordWasChanged;
use ParkManager\Module\CoreModule\Security\EventListener\AuthenticationTokenTokenPasswordChangedListener;
use ParkManager\Module\CoreModule\Security\SecurityUser;
 ...
 * @internal
 */
final class AuthenticationTokenTokenPasswordChangedListenerTest extends TestCase
{
