...
/**
 * A Constraints set indicate what the webhosting supports.
 *
 ...
 * like email (max mailboxes, max forwards, max aliases).
 *
 * A Constraint holds a specific configuration and is unaware
 * of the space it's used in.
 *
