Park-Manager DomainEvent
========================

The Park-Manager DomainEvent component, see resources for more information.

Resources
---------

  * [Documentation](http://docs.park-manager.com/current/component/domain-event/index.html)
