...
use ParkManager\Component\User\Tests\Fixtures\SecurityUserExtended;
use ParkManager\Component\User\Tests\Fixtures\SecurityUserSecond;
...
final class SecurityUserTest extends TestCase
{
    ...
    public function its_username_equals_UserId()
    {
        ...
        self::assertSame(self::ID1, $securityUser->id());
