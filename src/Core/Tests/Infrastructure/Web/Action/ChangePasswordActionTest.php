...
namespace ParkManager\Core\Tests\Infrastructure\Web\Action;

use ParkManager\Bundle\UserBundle\Tests\Action\ChangePasswordActionTestCase;
...
final class ChangePasswordActionTest extends ChangePasswordActionTestCase
{
    ...
    {
        return $client->getContainer()->get('router')->generate('admin_home');
    }
