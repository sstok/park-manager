...
final class TwigResponseTest extends TestCase
{
    ...
    {
        $response = new TwigResponse('@CoreBundle/client/show_user.html.twig', ['foo' => 'bar']);

        static::assertSame(200, $response->getStatusCode());
        static::assertSame('@CoreBundle/client/show_user.html.twig', $response->getTemplate());
    ...
    {
        $response = new TwigResponse('@CoreBundle/client/show_user.html.twig', ['foo' => 'bar'], 400);
    ...
    {
        $response = new TwigResponse('@CoreBundle/client/show_user.html.twig', ['foo' => 'bar'], 200, ['X-Foo' => 'bar']);
