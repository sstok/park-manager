...
final class CertificateFactoryImplTest extends TestCase
{
    ...
    public function it_creates_cert_not_previously_stored(): void
    {
        ...
        $objectManagerProphecy->find(Certificate::class, Argument::any())->willReturn(null);
        $objectManagerProphecy->persist(Argument::type(Certificate::class))->shouldBeCalledTimes(1);
    ...
    public function it_creates_cert_previously_stored(): void
    {
        ...
        $objectManagerProphecy = $this->prophesize(ObjectManager::class);
        $objectManagerProphecy->find(Certificate::class, Certificate::getHash($certContents))->willReturn($storedCertificate);
        $objectManagerProphecy->persist(Argument::type(Certificate::class))->shouldNotBeCalled();
        $objectManager = $objectManagerProphecy->reveal();
