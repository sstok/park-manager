...
final class CAResolverTest extends TestCase
{
    ...
    public function it_fails_with_incomplete_ca_list(): void
    {
        ...
        $objectManagerProphecy->find(CA::class, Argument::any())->willReturn(null);
    ...
    public function it_resolves_a_valid_ca_list(): void
    {
        $objectManagerProphecy = $this->prophesize(ObjectManager::class);
        $objectManagerProphecy->find(CA::class, Argument::any())->willReturn(null);
        $objectManagerProphecy->persist(Argument::type(CA::class))->shouldBeCalledTimes(2);
        $objectManager = $objectManagerProphecy->reveal();
    ...
    public function it_resolves_an_already_stored_ca(): void
    {
        ...
        $objectManagerProphecy = $this->prophesize(ObjectManager::class);
        $objectManagerProphecy->find(CA::class, CA::getHash($ca1))->willReturn($intermediateCA);
        $objectManagerProphecy->persist(Argument::type(CA::class))->shouldNotBeCalled();
        $objectManager = $objectManagerProphecy->reveal();
    ...
    public function it_resolves_an_already_stored_ca_without_matching_signature(): void
    {
        ...
        $objectManagerProphecy = $this->prophesize(ObjectManager::class);
        $objectManagerProphecy->find(CA::class, CA::getHash($ca1))->willReturn(null);
        $objectManagerProphecy->find(CA::class, CA::getHash($ca2))->willReturn($rootCA);
        $objectManagerProphecy->persist(Argument::type(CA::class))->shouldBeCalledTimes(1);
        $objectManager = $objectManagerProphecy->reveal();
